...
if (exists("p_meas")) {
  ...
  # Sárdi, K., Csathó, P., Osztoics, E. 2009. Evaluation of soil phosphorus contents in long-term experiments from environmental aspects. Proceedings of the 51st Georgikon Scientific Conference, Keszthely, Hungary, 807-815.
